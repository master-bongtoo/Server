...
$(document).ready(function(){                                                     
	$.ajax({
		url: "../../event/eventListJson.a?event_type=1&pg=<%=pg%>",
		type: "get",
		dataType: "json",
		cache: false,
		timeout: 30000,
...
<input type="button" id="QnaNotice1" value="공지사항" class="btn btn-blue" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice1_NoticeList.jsp'">
...
<br><br><br>
  ...
  <input type="button" value="◀" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice1_NoticeList.jsp?event_type=1&pg=<%=pre%>'">
  <input type="button" value="<%=pg %>" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice1_NoticeList.jsp?event_type=1&pg=<%=pg%>'">
  <input type="button" value="▶" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice1_NoticeList.jsp?event_type=1&pg=<%=next%>'">
</body>
</html>