...
$(document).ready(function(){                                                     
	$.ajax({
		url: "../../event/eventListJson.a?event_type=3",
		type: "get",
		dataType: "json",
		cache: false,
		timeout: 30000,
...
<input type="button" id="QnaNotice3" value="자주 묻는 질문" class="btn btn-blue" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice3_FaqList.jsp'">
...
<br><br><br>
  ...
  <input type="button" value="◀" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice3_FaqList.jsp?event_type=1&pg=<%=pre%>'">
  <input type="button" value="<%=pg %>" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice3_FaqList.jsp?event_type=1&pg=<%=pg%>'">
  <input type="button" value="▶" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice3_FaqList.jsp?event_type=1&pg=<%=next%>'">
  <br><br><br>
</body>
</html>