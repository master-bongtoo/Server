...
$(document).ready(function(){                                                     
	$.ajax({
		url: "../../event/eventListJson.a?event_type=4",
		type: "get",
		dataType: "json",
		cache: false,
		timeout: 30000,
		success : function(json){
			...
			for(var i=0; i<item.length; i++){
				...
				if(event_img_path){
					html += '<th>'+'<input type="image" class="header-image" src="'+event_img_path+'">'+'</th>';
				} else {
					html += '<th>'+'-'+'</th>';
				}
...
<input type="button" id="QnaNotice2" value="도움말" class="btn" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice2_HelpList.jsp'">
...
<input type="button" id="QnaNotice4" value="이벤트" class="btn btn-blue" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice4_EventList.jsp'">
<br><br><br>
  ...
  <input type="button" value="◀" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice4_EventList.jsp?event_type=1&pg=<%=pre%>'">
  <input type="button" value="<%=pg %>" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice4_EventList.jsp?event_type=1&pg=<%=pg%>'">
  <input type="button" value="▶" class="btn btn-red" onclick="location.href='/bongtoo/clientWeb/WebPage/AdminNotice4_EventList.jsp?event_type=1&pg=<%=next%>'">
  <br><br><br>
